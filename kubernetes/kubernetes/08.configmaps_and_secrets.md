...
You can use them as:
- Filesystem: mount a ConfigMap into a Pod (each entry is mounted as a file with the key as name, and content with the value)
- Environment variable
- Command-line argument (command line for a container based on ConfigMap values)
