...
[form kubernetes glossary](https://kubernetes.io/docs/reference/glossary/?fundamental=true):
...
from https://cloud.redhat.com/blog/introducing-operators-putting-operational-knowledge-into-software:
...
Admission controllers are called before the API Server, so before the object in stored.
